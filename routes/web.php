...
Route::get('/searchSongs', [SearchController::class, 'searchSongs'])->name('search.music.songs');
Route::get('/searchArtists', [SearchController::class, 'searchArtists'])->name('search.music.artists');